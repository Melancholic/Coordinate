...
I18n.translations["ru"] = I18n.extend((I18n.translations["ru"] || {}), {
    "about": "О проекте",
    "about_page": {
        "desc0": "Любопытный студент",
        "desc1": "Full-stack разработчик",
        "desc2": "Заядлый водитель",
        "developer_stamp": "Разработано Нагорным Андреем",
        "p1_html": "\u003cp\u003e\u003cstrong\u003eCoordinate\u003c/strong\u003e - некоммерческий и свободный проект, с использованием ряда зарегистрированных торговых марок и свободных библиотек.\u003c/p\u003e",
        "p2_html": "\u003cp\u003e\u003cstrong\u003eCoordinate\u003c/strong\u003e позволяет наблюдать за местоположением Ваших автомобилей, просматривать треки, и детальную статистику. Я старался сделать сервис, как можно более удобным для конечного пользователя, при этом не забывая о надежности и безопасности личных данных.\u003c/p\u003e",
        "p31_html": "\u003cp\u003eПроект все еще разрабатывается, и Ваши отзывы и пожелания важны для меня.",
        "p32_html": "Вы можете  отправить их мне, через соответствующую форму (%{contact}) или  по %{mail}.\u003c/p\u003e",
        "p4_html": "\u003cp\u003eСпасибо за Ваше внимание!\u003c/p\u003e",
        "p5_html": "\u003cp\u003eЯ выражаю глубокую благодарность за помощь и влияние в развитии сервиса, следующим проектам:\u003c/p\u003e"
    },
    "active_admin": {
        "access_denied": {"message": "Вы не авторизованы для выполнения данного действия."},
        "any": "Любой",
        "batch_actions": {
        ...
        "blank_slate": {"content": "Пока нет %{resource_name}.", "link": "Создать"},
        "cancel": "Отмена",
        "comments": {
            ...
            "errors": {"empty_text": "Комментарий не сохранен, текст не должен быть пустым."},
        ...
        "devise": {
            "change_password": {"submit": "Изменение пароля", "title": "Изменение пароля"},
            ...
            "login": {"remember_me": "Запомнить меня", "submit": "Войти", "title": "Войти"},
            "password": {"title": "Пароль"},
            "resend_confirmation_instructions": {
                "submit": "Выслать повторно письмо с активацией",
                "title": "Выслать повторно письмо с активацией"
            },
            "reset_password": {"submit": "Сбросить пароль", "title": "Забыли пароль?"},
            "sign_up": {"submit": "Зарегистрироваться", "title": "Зарегистрироваться"},
        ...
        "download": "Загрузка:",
        "dropdown_actions": {"button_label": "Oперации"},
        "edit": "Изменить",
        "edit_model": "Изменить %{model}",
        "empty": "Пусто",
        "filters": {
            "buttons": {"clear": "Очистить", "filter": "Фильтровать"},
            "predicates": {
                "contains": "Содержит",
        ...
        "index_list": {"block": "Список", "blog": "Блог", "grid": "Сетка", "table": "Таблица"},
        "logout": "Выйти",
        ...
        "pagination": {
            ...
            "entry": {"few": "записи", "many": "записей", "one": "запись", "other": "записей"},
        ...
        "sidebars": {"filters": "Фильтры", "search_status": "Статус поиска"},
        "status_tag": {"no": "Нет", "yes": "Да"},
        "unsupported_browser": {
    ...
    "activerecord": {
        "attributes": {
            ...
            "user": {
                ...
                "email": "E-mail",
                "is_agreed": "Принимаю все условия пользовательского соглашения",
                "locale": "Язык",
                "login": "Логин",
                "password": "Пароль",
        ...
        "errors": {
            "models": {
                "user": {
                    "attributes": {"is_agreed": {"accepted": "для пользования сервисом необходимо принять пользовательское соглашение."}},
                    "car": {
                        "priority_valid": "не входит в допустимый диапазон: 0 .. 10",
                        "title_uniq_valid": "Вы уже имеете автомобиль с таким названием."
                    }
                }
            }
        },
        "models": {"user": {"one": "Пользователь", "other": "Пользователи"}}
    },
    "author": "Нагорный Андрей",
    "authorization": "Авторизация",
    "breadcrumbs": {
        "application": {"root": "Главная"},
        "cars": "Ваши автомобили",
        "edit_cars": "Изменение автомобиля",
        "home": "Главная",
        "new_cars": "Новый автомобиль",
    ...
    "cars": {
        "car_card": {
            ...
            "created_at": "Создан",
            "description": "Описание",
            "head1": "Информация об автомобиле",
            "last_loc": "Последние координаты получены",
            "priority": "Приоритет",
            "total_tracks": "Всего треков",
            "uuid": "UUID трекера"
        },
        "edit": {"edit_car": "Изменение %{title}"},
        "index": {"head1": "Ваши автомобили"},
        "new": {"new_car": "Добавление автомобиля"},
        "new_form": {
            "img_destroy_hint": "Изображение автомобиля может быть удалено.",
            "img_destroy_txt": "Не использовать изображение",
            "upload_text": "Загрузить изображение для автомобиля"
        },
        "tooltip": {"wait_message": "Подождите, контент загружается ..."}
    },
    "change_but": "Изменить %{name}",
    "charts": {
        "all_cars": "Все автомобили",
        "distance4day": "Пройденное расстояние по дням",
        "distance4day_full": "Ежедневное расстояние треков",
        "distance_per_cars": "Процентное соотношение пройденного расстояния для автомобилей",
        "of_distance": "от общего расстояния",
        "of_tracks": "от общего кол-ва треков",
        "track_distance": "Длина трека (км)",
        "tracks": {
            "stats_of_track_by_user": {
                "avg_dist_per_car": "Среднее расстояние на автомобиль",
                "avg_dist_per_day": "Среднее расстояние в день",
                "avg_dist_per_track": "Среднее расстояние на трек",
                "avg_tracks_per_car": "Среднее кол-во треков на автомобиль",
                "avg_tracks_per_day": "Среднее кол-во треков в день",
                "favorite_car": "\"Любимый\" автомобиль",
                "total_days": "Всего дней, с момента создания первого трека",
                "total_distance": "Общее пройденное расстояние",
                "total_tracks": "Всего треков"
            }
        },
        "tracks_per_cars": "Процентное соотношение треков для автомобилей"
    },
    "close_but": "Закрыть",
    "confirm": {"cancel": "Отмена", "ok": "Ок", "title": "Подтверждение"},
    ...
    "datetime": {
        "distance_in_words": {
            ...
            "x_days": {"few": "%{count} дня", "many": "%{count} дней", "one": "%{count} день", "other": "%{count} дня"},
            "x_minutes": {
                "few": "%{count} минуты",
                "many": "%{count} минут",
                "one": "%{count} минуту",
    ...
    "faker": {
        "address": {
            ...
            "full_address": ["#{postcode} #{default_country}, #{city}, #{street_address}", "#{postcode} #{default_country}, #{city}, #{street_address} #{secondary_address}"],
            "postcode": ["######"],
            ...
            "street_name": ["#{street_suffix} #{Address.street_title}", "#{Address.street_title} #{street_suffix}"],
        ...
        "company": {
            "name": ["#{prefix} #{Name.female_first_name}", "#{prefix} #{Name.male_first_name}", "#{prefix} #{Name.male_last_name}", "#{prefix} #{suffix}#{suffix}", "#{prefix} #{suffix}#{suffix}#{suffix}", "#{prefix} #{Address.city_name}#{suffix}", "#{prefix} #{Address.city_name}#{suffix}#{suffix}", "#{prefix} #{Address.city_name}#{suffix}#{suffix}#{suffix}"],
        ...
        "name": {
            ...
            "name": ["#{male_first_name} #{male_last_name}", "#{male_last_name} #{male_first_name}", "#{male_first_name} #{male_middle_name} #{male_last_name}", "#{male_last_name} #{male_first_name} #{male_middle_name}", "#{female_first_name} #{female_last_name}", "#{female_last_name} #{female_first_name}", "#{female_first_name} #{female_middle_name} #{female_last_name}", "#{female_last_name} #{female_first_name} #{female_middle_name}"]
        },
        "phone_number": {"formats": ["+7(9##)###-##-##"]},
        "separator": " и "
    },
    "faq": {
        "back_to_top": "К началу",
        "q10b_html": "\u003cp\u003eПрава на владения сервисом (в том числе и мобильным приложением \"Coordinate-tracker\" принадлежат единственному разработчику сервиса - Нагорному Андрею. Вы можете узнать больше на странице \"%{link}\".\u003c/p\u003e",
        "q10h": "Кому принадлежат права на владение сервисом?",
        "q1b_html": "Для пользования сервисом Вы должны иметь устройство, под управлением \u003cstrong\u003eAndroid 2.0\u003c/strong\u003e и старше, с наличием \u003cstrong\u003eGPS\u003c/strong\u003e и \u003cstrong\u003eInternet\u003c/strong\u003e-соединения (EDGE/3G/4G/ и т.д.).\u003c/strong\u003e",
        "q1h": "Какие требования для пользования сервисом?",
        "q2_2b_html": "\u003cp\u003eДля начала, нужно зарегистрироваться, или войти (%{signin}).\u003c/p\u003e \u003cp\u003eЗатем, Вы должны будете заполнить Ваш профиль и добавить Ваш автомобиль. После чего, вы должны установить приложение \"Coordinate-tracker\" на Ваше устройсво.\u003c/p\u003e",
        "q2b_html": "\u003cp\u003eДля начала, нужно зарегистрироваться, или войти.\u003c/p\u003e \u003cp\u003eЗатем, Вы должны будете заполнить Ваш профиль (%{user}) и добавить Ваш автомобиль (%{car}). После чего, вы должны установить приложение \"Coordinate-tracker\" на Ваше устройсво.\u003c/p\u003e",
        "q2h": "С чего я могу начать?",
        "q3b_html": "\u003cp\u003eДалее необходимо установить (интегрировать) Ваше мобильное устройство в машину. Вы можете организовать питание от бортовой сети, или следите за состоянием батареи собственноручно.\u003c/p\u003e\u003cp\u003eПри совершении поездок, устройство будет автоматически передавать данные на наш сервер, для дальнейшей обработки и хранения.\u003c/p\u003e \u003cp\u003e\u003cstrong\u003eВнимание!\u003c/strong\u003e  Ваши данные будут доступны только вам!\u003c/p\u003e",
        "q3h": "Что потом?",
        "q4b_html": "\"Coordinate-tracker\" это приложение для ОС Android,  определяющее местоположение Вашего автомобиля (в котором установлено мобильное устройство, с запущенным \"Coordinate-tracker\") и отсылающая информацию к нам на сервер.",
        "q4h": "Что такое \"Coordinate-tracker\"?",
        "q5b_html": "\u003cp\u003eК сожалению, пока возможность загрузки приложения с \u003cstrong\u003eGoogle Play\u003c/strong\u003e не предусмотрена :(\u003c/p\u003e\u003cp\u003eК сожалению, пока возможность загрузки приложения с нашего сайте не предусмотрена :(\u003c/p\u003e\u003cp\u003eЯ работаю над этим!\u003c/p\u003e",
        "q5h": "Как я могу получить \"Coordinate-tracker\"?",
        "q6b_html": "\u003cp\u003eПри создании автомобиля, ему будет присвоен уникальный идентификатор трекера (UUID), который необходимо ввести при авторизации в приложении.\u003c/p\u003e\u003cp\u003e\u003cstrong\u003eЗамечание:\u003c/strong\u003e каждый автомобиль не может иметь более одного трекера!\u003c/p\u003e\u003cp\u003eТаким образом, для настройки трекера необходимо: email-пользователя, пароль пользователя и UUID конкретного автомобиля.\u003c/p\u003e",
        "q6h": "Как настроить \"Coordinate-tracker\"",
        "q7b_html": "После конфигурации \"Coordinate-tracker\" дальнейших действий не требуется. Можете спокойно путешествовать на своем автомобиле : все дальнейшие действия будут автоматизированы.\u003c/p\u003e\u003cp\u003eВы сможете наблюдать за местоположением и статистикой автомобиля на сайте сервиса.\u003c/p\u003e",
        "q7h": "Как пользоваться сервисом?",
        "q8b_html": "\u003cp\u003eПодробную статистику Вы можете посмотреть в своем профиле %{link}, после регистрации.\u003c/p\u003e",
        "q8h": "Как просмотреть подробную статистику?",
        "q9b_html": "\u003cp\u003eИнформацию о Ваших треках Вы можете посмотреть в своем профиле %{link}, после регистрации.",
        "q9h": "Как просмотреть информацию о треках?"
    },
    "fix_but": "Исправить",
    ...
    "helpers": {
        ...
        "submit": {"create": "Создать %{model}", "submit": "Сохранить %{model}", "update": "Сохранить %{model}"},
        "titles": {
    ...
    "license_agreement": "Лицензионное соглашениие",
    "loading": "Загрузка...",
    "log_in": "Войти",
    "map": {
        "address": "Адрес",
        ...
        "lines": "Линии",
        "long": "Долгота",
        "max_distance": "Максимальная длина трека",
        "max_duration": "Максимальная длительность трека",
        "max_speed": "Максимальная скорость",
        "min_distance": "Минимальная длина трека",
        "min_duration": "Минимальная длительность трека",
    ...
    "maps": {
        "tracks": {
            "info": {"head": "Подробная статистика о треке %{track}"},
            "info_all": {"head": "Подробная статистика обо всех выбранных треков"}
        }
    },
    "mask_loading_label": "Загрузка...",
    "max_selected_track": "Максимум: %{count}",
    "min_val": "мин.",
    "modals": {
        "access_error": "Ошибка доступа!",
        "car_deleting": "Автомобиль \"%{car}\" успешно удален!",
        "car_not_deleting": "Ошибка! Автомобиль \"%{title}\" не был удален!",
        "car_saved": "Автомобиль успешно сохранен!",
        "car_updating": "Автомобиль \"%{car}\" успешно обновлен!",
        "del_car_confirm_html": "\u003ch4\u003eВы согласны удалить данный автомобиль: \u003cb\u003e%{title}\u003c/b\u003e ?\u003cbr\u003e\u003cp class='text-danger'\u003eВнимание: Все данные будут безвозвратно удалены!\u003c/p\u003e\u003c/h4\u003e",
        "lifetime_ended": "Время жизни ссылки завершено. Пожалуйста, повторите операцию вновь!",
        "max_length_msg": "Максимальная длина: {{max}} символов!",
        "reset_pass_email_not_founded": "Пользователь с адресом  %{email} не найден!",
        "reset_pass_send": "Письмо с инструкциями было отправлено на адрес:  %{email}!",
        "send_verif_instruct": "Письмо с инструкциями было отправлено на адрес: %{email}",
        "uncorrect_login_data": "неккоректный e-mail или пароль!",
        "uncorrect_params": "Неккоректные параметры!",
        "user_mails_thank": "Спасибо за Ваше сообщение! Мы свяжемся с Вами при первой возможности!",
        "user_not_agreed": "Для пользования сервисом Вы обязаны принять пользовательское соглашение.",
        "user_not_deleted_self": "Ошибка! Вы не можите удалить себя!",
        "user_not_verificated": "Ошибка! Пользователь %{user} не был подтвержден!",
        "user_verificated": "Пользователь %{user} успешно подтвержден!",
        "usr_deleted": "Пользователь \"%{ulogin}\" был удален!",
        "usr_not_deleted": "Ошибка! Пользователь \"%{ulogin}\" не был удален!",
        "usr_updating": "Профиль успешно обновлен!",
        "warning": "Предупреждение!",
        "welcome_msg": "%{user}, Добро пожаловать в \"Coordinate\"!"
    },
    "not_car_b": "Вам необходимо перейти в настройки и добавить автомобиль.",
    "not_car_h": "Вы не добавили ни одного автомобиля!",
    "not_tracks_b": "Узнайте, как привязать Ваш трекер к автомобилю!",
    "not_tracks_h": "У вас нет ни одного трека...",
    "now": "сейчас",
    "number": {
        "currency": {
            "format": {
        ...
        "human": {
            "decimal_units": {
                ...
                "units": {
                    ...
                    "million": {"few": "миллионов", "many": "миллионов", "one": "миллион", "other": "миллионов"},
                    "quadrillion": {
                        "few": "квадриллионов",
                        "many": "квадриллионов",
                        "one": "квадриллион",
                    ...
                    "thousand": {"few": "тысяч", "many": "тысяч", "one": "тысяча", "other": "тысяч"},
                    "trillion": {"few": "триллионов", "many": "триллионов", "one": "триллион", "other": "триллионов"},
                    "unit": ""
                }
            },
            "format": {"delimiter": "", "precision": 1, "significant": false, "strip_insignificant_zeros": false},
            "storage_units": {
                "format": "%n %u",
                "units": {
                    "byte": {"few": "байта", "many": "байт", "one": "байт", "other": "байта"},
                    "gb": "ГБ",
                    "kb": "КБ",
                    "mb": "МБ",
                    "tb": "ТБ"
    ...
    "shared": {
        "empty_message": {
            "msg": "Какое-то содержимое...",
            "sub_msg": "Здесь должна быть информация, о которой мы забыли =(. Пожалуйста, сообщите об этом..."
        },
        "question": {"body_default": "Некоторое содержимое ...", "header_default": "Некоторый текст заголовка..."},
        "settings_nav": {
            "car_settings": "Настройки автомобилей",
            "my_cars": "Мои автомобили",
            "new_cars": "Добавить автомобиль",
    ...
    "sign_up": "Регистрация",
    "simple_captcha": {
        "label": "Введите значение с картинки",
        "message": {
            "default": "Секретный код отличается от кода с изображения",
            "user": "Введенный Вами код отличается от кода с изображения"
        },
        "placeholder": "код с картинки",
        "refresh_button_text": "Обновить"
    },
    "simple_form": {
        "error_notification": {"default_message": "Пожалуйста, исправьте следующие ошибки:"},
        "labels": {
            "car": {"color": "Цвет", "description": "Описание", "priority": "Приоритет", "title": "Название"},
            "defaults": {
                "email": "E-mail",
                "login": "Логин",
                "password": "Пароль",
        ...
        "no": "Нет",
        "required": {"mark": "*", "text": "Обязательное для заполнения"},
        "yes": "Да"
    },
    "speed_val": "км/ч",
    "static_pages": {
        "agreement": {"agreed_but": "С условиями согласен"},
        "home4guest": {
            "descript1": "Coordinate это сервис, позволяющий отслеживать перемещение и местоположение Вашего автомобиля.",
            "welcome": "Добро пожаловать в \"Coordinate\"!"
        },
        "home4user": {
            "date_pick": "Выберите дату:",
            "date_pick_at": "от:",
            "date_pick_to": "до:",
            "select_car": "Выберите автомобиль:",
            "select_tracks": "Выберите треки (\u003c15):"
        }
    },
    "support": {"array": {"last_word_connector": " и ", "two_words_connector": " и ", "words_connector": ", "}},
    "time": {
        "am": "утра",
        "formats": {"default": "%a, %d %b %Y, %H:%M:%S %z", "long": "%d %B %Y, %H:%M", "short": "%d %b, %H:%M"},
        "pm": "вечера"
    },
    "to_FAQ": "перейти в FAQ",
    ...
    "users": {
        "cars": {
            ...
            "created_at": "Создан",
            "image": "Изобр.",
            "last_track": "Последний трек",
            "priority": "Приоритет",
            "title": "Название",
            "total_tracks": "Всего треков"
        },
        "edit": {
            "change_gravatar": "Изменить Gravatar",
            "change_gravatar_hint": "Ваш gravatar будет изменен на сайте проекта \"Gravatar\"",
            "delete_avatar_hint": "Вы будете использовать глобальный аватар (grvatar) (http://gravatar.com), а загружаемый аватар будет удален.",
            "delete_avatar_label": "Не использовать загружаемый аватар",
            "head1": "Пользовательские настройки",
            "profile_settings": "Настройки профиля",
            "region_settings": "Настройки региона",
            "system_settings": "Системные настройки",
            "upload_avatar": "Загрузить Ваш аватар",
            "user_settings": "Настройки пользователя"
        },
        "reset_password_email_form": {
            "head1": "Сброс пароля, шаг 1",
            "head2": "На указанный адрес будут высланы инструкции, с дальнейшими указаниями. проверьте свой e-mail!"
        },
        "reset_password_new_pass_request": {"head1": "Сброс пароля, шаг 2", "head2": "Введите новый пароль!"},
        "show": {"edit_info": "Изменить информацию"},
        "users_charts": {"track_statistic_head": "Общая статистика о треках"},
        "verification": {"head2": "На указанный Вами e-mail отправлены инструкции, с указаниями, необходимыми для завершения подтвержения e-mail адреса. Пожалуйста, проверьте свой e-mail!"},
        "verification_form": {"letter_to": "код на адрес: %{mail}.", "verification_key": "Код:"}
    },
    "verification": "Подтверждение e-mail",
    "will_paginate": {
        "next_label": "Вперед \u0026#8594;",
        "page_entries_info": {
...
I18n.translations["en"] = I18n.extend((I18n.translations["en"] || {}), {
    ...
    "active_admin": {
        "access_denied": {"message": "You are not authorized to perform this action."},
        "any": "Any",
        "batch_actions": {
        ...
        "blank_slate": {"content": "There are no %{resource_name} yet.", "link": "Create one"},
        "cancel": "Cancel",
        "comments": {
            "add": "Add Comment",
            "author": "Author",
            ...
            "errors": {"empty_text": "Comment wasn't saved, text was empty."},
        ...
        "devise": {
            "change_password": {"submit": "Change my password", "title": "Change your password"},
            "email": {"title": "Email"},
            "links": {
            ...
            "login": {"remember_me": "Remember me", "submit": "Login", "title": "Login"},
            "password": {"title": "Password"},
            "resend_confirmation_instructions": {
                "submit": "Resend confirmation instructions",
                "title": "Resend confirmation instructions"
            },
            "reset_password": {"submit": "Reset My Password", "title": "Forgot your password?"},
            "sign_up": {"submit": "Sign up", "title": "Sign up"},
            "subdomain": {"title": "Subdomain"},
            "unlock": {"submit": "Resend unlock instructions", "title": "Resend unlock instructions"},
            "username": {"title": "Username"}
        },
        "download": "Download:",
        "dropdown_actions": {"button_label": "Actions"},
        "edit": "Edit",
        "edit_model": "Edit %{model}",
        "empty": "Empty",
        "filters": {
            "buttons": {"clear": "Clear Filters", "filter": "Filter"},
            "predicates": {
                "contains": "Contains",
                "ends_with": "Ends with",
                "equals": "Equals",
        ...
        "index_list": {"block": "List", "blog": "Blog", "grid": "Grid", "table": "Table"},
        "logout": "Logout",
        ...
        "pagination": {
            ...
            "entry": {"few": "записи", "many": "записей", "one": "entry", "other": "entries"},
        ...
        "sidebars": {"filters": "Filters", "search_status": "Search Status"},
        "status_tag": {"no": "No", "yes": "Yes"},
        "unsupported_browser": {
    ...
    "activerecord": {
        ...
        "errors": {
            ...
            "models": {
                "user": {
                    "attributes": {"is_agreed": {"accepted": "to use the service, you must accept the user agreement."}},
                    "car": {
    ...
    "cars": {
        "car_card": {
            ...
            "description": "Description",
            "head1": "Car information",
            "last_loc": "Last location at",
            "priority": "Priority",
            "total_tracks": "Total tracks",
            "uuid": "Tracker UUID"
        },
        "edit": {"edit_car": "Edit %{title}"},
        "index": {"head1": "Your cars"},
        "new": {"new_car": "Add new car"},
        "new_form": {
            "img_destroy_hint": "Your image will be deleted.",
            "img_destroy_txt": "Don't use custom image",
            "upload_text": "Upload image of this car"
        },
        "tooltip": {"wait_message": "Wait while we load new content..."}
    },
    "change_but": "Change %{name}",
    "charts": {
        "all_cars": "All your cars",
        "distance4day": "Distance for days",
        "distance4day_full": "The daily distance of your tracks",
        "distance_per_cars": "The percentage distance for cars",
        "of_distance": "of total distance",
        "of_tracks": "of total tracks",
        "track_distance": "Track distance (km)",
        "tracks": {
            "stats_of_track_by_user": {
                "avg_dist_per_car": "Average distance per car",
                "avg_dist_per_day": "Average distance per day",
                "avg_dist_per_track": "Average distance per track",
                "avg_tracks_per_car": "Average tracks per car",
                "avg_tracks_per_day": "Average tracks per day",
                "favorite_car": "Favorite car",
                "total_days": "Total days, since the establishment of the first track",
                "total_distance": "Total distance",
                "total_tracks": "Total tracks"
            }
        },
        "tracks_per_cars": "The percentage tracks for cars"
    },
    "close_but": "Close",
    "confirm": {"cancel": "Cancel", "ok": "Ok", "title": "Confirmation"},
    ...
    "datetime": {
        "distance_in_words": {
            ...
            "x_days": {"few": "%{count} дня", "many": "%{count} дней", "one": "1 day", "other": "%{count} days"},
            "x_minutes": {
                "few": "%{count} минуты",
                "many": "%{count} минут",
                "one": "1 minute",
    ...
    "exception_logger": {
        "logged_exceptions": {
            "index": {
                ...
                "today": "Today"
            }, "show": {"title": "Logged Exception"}
        }
    },
    "faker": {
        "address": {
            "building_number": ["#####", "####", "###"],
            "city": ["#{city_prefix} #{Name.first_name}#{city_suffix}", "#{city_prefix} #{Name.first_name}", "#{Name.first_name}#{city_suffix}", "#{Name.last_name}#{city_suffix}"],
            "city_name": ["Москва", "Владимир", "Санкт-Петербург", "Новосибирск", "Екатеринбург", "Нижний Новгород", "Самара", "Казань", "Омск", "Челябинск", "Ростов-на-Дону", "Уфа", "Волгоград", "Пермь", "Красноярск", "Воронеж", "Саратов", "Краснодар", "Тольятти", "Ижевск", "Барнаул", "Ульяновск", "Тюмень", "Иркутск", "Владивосток", "Ярославль", "Хабаровск", "Махачкала", "Оренбург", "Новокузнецк", "Томск", "Кемерово", "Рязань", "Астрахань", "Пенза", "Липецк", "Тула", "Киров", "Чебоксары", "Курск", "Брянск", "Магнитогорск", "Иваново", "Тверь", "Ставрополь", "Белгород", "Сочи"],
            ...
            "full_address": ["#{street_address}, #{city}, #{state_abbr} #{zip_code}", "#{secondary_address} #{street_address}, #{city}, #{state_abbr} #{zip_code}"],
            "postcode": ["#####", "#####-####"],
            "postcode_by_state": ["#####", "#####-####"],
            ...
            "street_name": ["#{Name.first_name} #{street_suffix}", "#{Name.last_name} #{street_suffix}"],
        ...
        "artist": {"names": ["Donatello", "Botticelli", "Michelangelo", "Raphael", "Titian", "Durer", "Caravaggio", "Rubens", "Bernini", "Rembrandt", "Pissarro", "Manet", "Degas", "Cezanne", "Monet", "Renoir", "Cassatt", "Gauguin", "Munch", "Klimt", "Matisse", "Picasso", "Kandinsky", "Chagall", "Seurat", "Magritte", "Escher", "Rothko", "Dali", "Kahlo", "Pollock", "Warhol", "Vettriano", "Da Vinci", "El Greco", "Winslow Homer", "Paul Klee", "Edward Hopper", "Diego Rivera", "Vincent", "Joan Miro", "Ansel Adams"]},
        "bank": {
            "iban_details": [{
                "bank_country_code": "AT",
                "iban_letter_code": "0",
                "iban_digits": "18"
            }, {"bank_country_code": "BG", "iban_letter_code": "4", "iban_digits": "14"}, {
                "bank_country_code": "BE",
                "iban_letter_code": "0",
                "iban_digits": "14"
            }, {"bank_country_code": "CY", "iban_letter_code": "0", "iban_digits": "26"}, {
                "bank_country_code": "CZ",
                "iban_letter_code": "0",
                "iban_digits": "22"
            }, {"bank_country_code": "DE", "iban_letter_code": "0", "iban_digits": "20"}, {
                "bank_country_code": "DK",
                "iban_letter_code": "0",
                "iban_digits": "16"
            }, {"bank_country_code": "EE", "iban_letter_code": "0", "iban_digits": "18"}, {
                "bank_country_code": "ES",
                "iban_letter_code": "0",
                "iban_digits": "22"
            }, {"bank_country_code": "FI", "iban_letter_code": "0", "iban_digits": "16"}, {
                "bank_country_code": "FR",
                "iban_letter_code": "0",
                "iban_digits": "25"
            }, {"bank_country_code": "GB", "iban_letter_code": "4", "iban_digits": "14"}, {
                "bank_country_code": "GR",
                "iban_letter_code": "0",
                "iban_digits": "25"
            }, {"bank_country_code": "HU", "iban_letter_code": "0", "iban_digits": "28"}, {
                "bank_country_code": "HR",
                "iban_letter_code": "0",
                "iban_digits": "19"
            }, {"bank_country_code": "IE", "iban_letter_code": "4", "iban_digits": "16"}, {
                "bank_country_code": "IT",
                "iban_letter_code": "0",
                "iban_digits": "25"
            }, {"bank_country_code": "LV", "iban_letter_code": "4", "iban_digits": "15"}, {
                "bank_country_code": "LT",
                "iban_letter_code": "0",
                "iban_digits": "14"
            }, {"bank_country_code": "LU", "iban_letter_code": "0", "iban_digits": "16"}, {
                "bank_country_code": "PL",
                "iban_letter_code": "0",
                "iban_digits": "24"
            }, {"bank_country_code": "PT", "iban_letter_code": "0", "iban_digits": "18"}, {
                "bank_country_code": "MT",
                "iban_letter_code": "4",
                "iban_digits": "26"
            }, {"bank_country_code": "NL", "iban_letter_code": "4", "iban_digits": "12"}, {
                "bank_country_code": "RO",
                "iban_letter_code": "4",
                "iban_digits": "18"
            }, {"bank_country_code": "SE", "iban_letter_code": "0", "iban_digits": "22"}, {
        ...
        "company": {
            ...
            "name": ["#{Name.last_name} #{suffix}", "#{Name.last_name}-#{Name.last_name}", "#{Name.last_name}, #{Name.last_name} and #{Name.last_name}"],
            "prefix": ["ИП", "ООО", "ЗАО", "ОАО", "НКО", "ТСЖ", "ОП"],
        ...
        "esports": {
            "events": ["ESL Cologne", "MLG Meadowlands", "GFinity London", "Worlds", "IEM Championship", "League All Stars"],
            "games": ["CS:GO", "League of Legends", "Overwatch", "StarCraft II", "Dota2", "Super Smash Bros. Melee", "Hearthstone"],
            "leagues": ["ESL", "IEM", "MLG", "GFinity"],
        ...
        "job": {
            ...
            "title": ["#{seniority} #{field} #{position}", "#{seniority} #{field} #{position}", "#{field} #{position}", "#{field} #{position}", "#{seniority} #{position}"]
        },
        "lord_of_the_rings": {
        ...
        "music": {"instruments": ["Electric Guitar", "Acoustic Guitar", "Flute", "Trumpet", "Clarinet", "Cello", "Harp", "Xylophone", "Harmonica", "Accordion", "Organ", "Piano", "Ukelele", "Saxophone", "Drums", "Violin", "Bass Guitar"]},
        "name": {
            "female_first_name": ["Анна", "Алёна", "Алевтина", "Александра", "Алина", "Алла", "Анастасия", "Ангелина", "Анжела", "Анжелика", "Антонида", "Антонина", "Анфиса", "Арина", "Валентина", "Валерия", "Варвара", "Василиса", "Вера", "Вероника", "Виктория", "Галина", "Дарья", "Евгения", "Екатерина", "Елена", "Елизавета", "Жанна", "Зинаида", "Зоя", "Ирина", "Кира", "Клавдия", "Ксения", "Лариса", "Лидия", "Любовь", "Людмила", "Маргарита", "Марина", "Мария", "Надежда", "Наталья", "Нина", "Оксана", "Ольга", "Раиса", "Регина", "Римма", "Светлана", "София", "Таисия", "Тамара", "Татьяна", "Ульяна", "Юлия"],
            "female_last_name": ["Смирнова", "Иванова", "Кузнецова", "Попова", "Соколова", "Лебедева", "Козлова", "Новикова", "Морозова", "Петрова", "Волкова", "Соловьева", "Васильева", "Зайцева", "Павлова", "Семенова", "Голубева", "Виноградова", "Богданова", "Воробьева", "Федорова", "Михайлова", "Беляева", "Тарасова", "Белова", "Комарова", "Орлова", "Киселева", "Макарова", "Андреева", "Ковалева", "Ильина", "Гусева", "Титова", "Кузьмина", "Кудрявцева", "Баранова", "Куликова", "Алексеева", "Степанова", "Яковлева", "Сорокина", "Сергеева", "Романова", "Захарова", "Борисова", "Королева", "Герасимова", "Пономарева", "Григорьева", "Лазарева", "Медведева", "Ершова", "Никитина", "Соболева", "Рябова", "Полякова", "Цветкова", "Данилова", "Жукова", "Фролова", "Журавлева", "Николаева", "Крылова", "Максимова", "Сидорова", "Осипова", "Белоусова", "Федотова", "Дорофеева", "Егорова", "Матвеева", "Боброва", "Дмитриева", "Калинина", "Анисимова", "Петухова", "Антонова", "Тимофеева", "Никифорова", "Веселова", "Филиппова", "Маркова", "Большакова", "Суханова", "Миронова", "Ширяева", "Александрова", "Коновалова", "Шестакова", "Казакова", "Ефимова", "Денисова", "Громова", "Фомина", "Давыдова", "Мельникова", "Щербакова", "Блинова", "Колесникова", "Карпова", "Афанасьева", "Власова", "Маслова", "Исакова", "Тихонова", "Аксенова", "Гаврилова", "Родионова", "Котова", "Горбунова", "Кудряшова", "Быкова", "Зуева", "Третьякова", "Савельева", "Панова", "Рыбакова", "Суворова", "Абрамова", "Воронова", "Мухина", "Архипова", "Трофимова", "Мартынова", "Емельянова", "Горшкова", "Чернова", "Овчинникова", "Селезнева", "Панфилова", "Копылова", "Михеева", "Галкина", "Назарова", "Лобанова", "Лукина", "Белякова", "Потапова", "Некрасова", "Хохлова", "Жданова", "Наумова", "Шилова", "Воронцова", "Ермакова", "Дроздова", "Игнатьева", "Савина", "Логинова", "Сафонова", "Капустина", "Кириллова", "Моисеева", "Елисеева", "Кошелева", "Костина", "Горбачева", "Орехова", "Ефремова", "Исаева", "Евдокимова", "Калашникова", "Кабанова", "Носкова", "Юдина", "Кулагина", "Лапина", "Прохорова", "Нестерова", "Харитонова", "Агафонова", "Муравьева", "Ларионова", "Федосеева", "Зимина", "Пахомова", "Шубина", "Игнатова", "Филатова", "Крюкова", "Рогова", "Кулакова", "Терентьева", "Молчанова", "Владимирова", "Артемьева", "Гурьева", "Зиновьева", "Гришина", "Кононова", "Дементьева", "Ситникова", "Симонова", "Мишина", "Фадеева", "Комиссарова", "Мамонтова", "Носова", "Гуляева", "Шарова", "Устинова", "Вишнякова", "Евсеева", "Лаврентьева", "Брагина", "Константинова", "Корнилова", "Авдеева", "Зыкова", "Бирюкова", "Шарапова", "Никонова", "Щукина", "Дьячкова", "Одинцова", "Сазонова", "Якушева", "Красильникова", "Гордеева", "Самойлова", "Князева", "Беспалова", "Уварова", "Шашкова", "Бобылева", "Доронина", "Белозерова", "Рожкова", "Самсонова", "Мясникова", "Лихачева", "Бурова", "Сысоева", "Фомичева", "Русакова", "Стрелкова", "Гущина", "Тетерина", "Колобова", "Субботина", "Фокина", "Блохина", "Селиверстова", "Пестова", "Кондратьева", "Силина", "Меркушева", "Лыткина", "Турова"],
            "female_middle_name": ["Александровна", "Алексеевна", "Альбертовна", "Анатольевна", "Андреевна", "Антоновна", "Аркадьевна", "Арсеньевна", "Артёмовна", "Борисовна", "Вадимовна", "Валентиновна", "Валерьевна", "Васильевна", "Викторовна", "Витальевна", "Владимировна", "Владиславовна", "Вячеславовна", "Геннадьевна", "Георгиевна", "Германовна", "Григорьевна", "Данииловна", "Денисовна", "Дмитриевна", "Евгеньевна", "Егоровна", "Ивановна", "Игнатьевна", "Игоревна", "Ильинична", "Константиновна", "Лаврентьевна", "Леонидовна", "Макаровна", "Максимовна", "Матвеевна", "Михайловна", "Никитична", "Николаевна", "Олеговна", "Романовна", "Семёновна", "Сергеевна", "Станиславовна", "Степановна", "Фёдоровна", "Эдуардовна", "Юрьевна", "Ярославовна"],
            ...
            "male_last_name": ["Смирнов", "Иванов", "Кузнецов", "Попов", "Соколов", "Лебедев", "Козлов", "Новиков", "Морозов", "Петров", "Волков", "Соловьев", "Васильев", "Зайцев", "Павлов", "Семенов", "Голубев", "Виноградов", "Богданов", "Воробьев", "Федоров", "Михайлов", "Беляев", "Тарасов", "Белов", "Комаров", "Орлов", "Киселев", "Макаров", "Андреев", "Ковалев", "Ильин", "Гусев", "Титов", "Кузьмин", "Кудрявцев", "Баранов", "Куликов", "Алексеев", "Степанов", "Яковлев", "Сорокин", "Сергеев", "Романов", "Захаров", "Борисов", "Королев", "Герасимов", "Пономарев", "Григорьев", "Лазарев", "Медведев", "Ершов", "Никитин", "Соболев", "Рябов", "Поляков", "Цветков", "Данилов", "Жуков", "Фролов", "Журавлев", "Николаев", "Крылов", "Максимов", "Сидоров", "Осипов", "Белоусов", "Федотов", "Дорофеев", "Егоров", "Матвеев", "Бобров", "Дмитриев", "Калинин", "Анисимов", "Петухов", "Антонов", "Тимофеев", "Никифоров", "Веселов", "Филиппов", "Марков", "Большаков", "Суханов", "Миронов", "Ширяев", "Александров", "Коновалов", "Шестаков", "Казаков", "Ефимов", "Денисов", "Громов", "Фомин", "Давыдов", "Мельников", "Щербаков", "Блинов", "Колесников", "Карпов", "Афанасьев", "Власов", "Маслов", "Исаков", "Тихонов", "Аксенов", "Гаврилов", "Родионов", "Котов", "Горбунов", "Кудряшов", "Быков", "Зуев", "Третьяков", "Савельев", "Панов", "Рыбаков", "Суворов", "Абрамов", "Воронов", "Мухин", "Архипов", "Трофимов", "Мартынов", "Емельянов", "Горшков", "Чернов", "Овчинников", "Селезнев", "Панфилов", "Копылов", "Михеев", "Галкин", "Назаров", "Лобанов", "Лукин", "Беляков", "Потапов", "Некрасов", "Хохлов", "Жданов", "Наумов", "Шилов", "Воронцов", "Ермаков", "Дроздов", "Игнатьев", "Савин", "Логинов", "Сафонов", "Капустин", "Кириллов", "Моисеев", "Елисеев", "Кошелев", "Костин", "Горбачев", "Орехов", "Ефремов", "Исаев", "Евдокимов", "Калашников", "Кабанов", "Носков", "Юдин", "Кулагин", "Лапин", "Прохоров", "Нестеров", "Харитонов", "Агафонов", "Муравьев", "Ларионов", "Федосеев", "Зимин", "Пахомов", "Шубин", "Игнатов", "Филатов", "Крюков", "Рогов", "Кулаков", "Терентьев", "Молчанов", "Владимиров", "Артемьев", "Гурьев", "Зиновьев", "Гришин", "Кононов", "Дементьев", "Ситников", "Симонов", "Мишин", "Фадеев", "Комиссаров", "Мамонтов", "Носов", "Гуляев", "Шаров", "Устинов", "Вишняков", "Евсеев", "Лаврентьев", "Брагин", "Константинов", "Корнилов", "Авдеев", "Зыков", "Бирюков", "Шарапов", "Никонов", "Щукин", "Дьячков", "Одинцов", "Сазонов", "Якушев", "Красильников", "Гордеев", "Самойлов", "Князев", "Беспалов", "Уваров", "Шашков", "Бобылев", "Доронин", "Белозеров", "Рожков", "Самсонов", "Мясников", "Лихачев", "Буров", "Сысоев", "Фомичев", "Русаков", "Стрелков", "Гущин", "Тетерин", "Колобов", "Субботин", "Фокин", "Блохин", "Селиверстов", "Пестов", "Кондратьев", "Силин", "Меркушев", "Лыткин", "Туров"],
            "male_middle_name": ["Александрович", "Алексеевич", "Альбертович", "Анатольевич", "Андреевич", "Антонович", "Аркадьевич", "Арсеньевич", "Артёмович", "Борисович", "Вадимович", "Валентинович", "Валерьевич", "Васильевич", "Викторович", "Витальевич", "Владимирович", "Владиславович", "Вячеславович", "Геннадьевич", "Георгиевич", "Германович", "Григорьевич", "Даниилович", "Денисович", "Дмитриевич", "Евгеньевич", "Егорович", "Иванович", "Игнатьевич", "Игоревич", "Ильич", "Константинович", "Лаврентьевич", "Леонидович", "Лукич", "Макарович", "Максимович", "Матвеевич", "Михайлович", "Никитич", "Николаевич", "Олегович", "Романович", "Семёнович", "Сергеевич", "Станиславович", "Степанович", "Фёдорович", "Эдуардович", "Юрьевич", "Ярославович"],
            "name": ["#{prefix} #{first_name} #{last_name}", "#{first_name} #{last_name} #{suffix}", "#{first_name} #{last_name}", "#{first_name} #{last_name}", "#{first_name} #{last_name}", "#{first_name} #{last_name}"],
            "name_with_middle": ["#{prefix} #{first_name} #{first_name} #{last_name}", "#{first_name} #{first_name} #{last_name} #{suffix}", "#{first_name} #{first_name} #{last_name}", "#{first_name} #{first_name} #{last_name}", "#{first_name} #{first_name} #{last_name}", "#{first_name} #{first_name} #{last_name}"],
        ...
        "phone_number": {"formats": ["###-###-####", "(###) ###-####", "1-###-###-####", "###.###.####", "###-###-####", "(###) ###-####", "1-###-###-####", "###.###.####", "###-###-#### x###", "(###) ###-#### x###", "1-###-###-#### x###", "###.###.#### x###", "###-###-#### x####", "(###) ###-#### x####", "1-###-###-#### x####", "###.###.#### x####", "###-###-#### x#####", "(###) ###-#### x#####", "1-###-###-#### x#####", "###.###.#### x#####"]},
        "pokemon": {
        ...
        "slack_emoji": {
            ...
            "emoji": ["#{people}", "#{nature}", "#{food_and_drink}", "#{celebration}", "#{activity}", "#{travel_and_places}", "#{objects_and_symbols}", "#{custom}"],
        ...
        "superhero": {
            ...
            "name": ["#{Superhero.prefix} #{Superhero.descriptor} #{Superhero.suffix}", "#{Superhero.prefix} #{Superhero.descriptor}", "#{Superhero.descriptor} #{Superhero.suffix}", "#{Superhero.descriptor}"],
    ...
    "helpers": {
        ...
        "page_entries_info": {
            "entry": {"one": "entry", "other": "entries", "zero": "entries"},
        ...
        "titles": {"delete": "Delete %{model}", "edit": "Edit %{model}", "new": "New %{model}", "save": "Save %{model}"}
    },
    "here": "here",
    "home": "Home",
    "hours_val": "hrs",
    ...
    "map": {
        ...
        "lines": "Lines",
        "long": "Longitude",
        "max_distance": "Max track length",
        "max_duration": "Max track duration",
        "max_speed": "Max speed",
        "min_distance": "Min track length",
        "min_duration": "Min track duration",
        "min_speed": "Min speed",
        "points": "Points",
        "speed": "Speed",
    ...
    "maps": {
        "tracks": {
            "info": {"head": "General statistic of track %{track}"},
            "info_all": {"head": "General statistic of all selected track"}
        }
    },
    "mask_loading_label": "Loading...",
    "max_selected_track": "Maximum: %{count}",
    "min_val": "min.",
    "modals": {
        "access_error": "Access error!",
        "car_deleting": "Car \"%{car}\" has been deleted!",
        "car_not_deleting": "Car \"%{title}\" has not been deleted!",
        "car_saved": "Car has been saved!",
        "car_updating": "Updating car \"%{car}\" is success",
        "del_car_confirm_html": "\u003ch4\u003eAre you sure you want to delete this car: \u003cb\u003e%{title}\u003c/b\u003e ?\u003cbr\u003e\u003cp class='text-danger'\u003eWarning: All data on it will be deleted permanently!\u003c/p\u003e\u003c/h4\u003e",
        "lifetime_ended": "The lifetime of this reference completion. Please try the request again.",
        "max_length_msg": "The maximum length of the field contents: {{max}} symbols!",
        "reset_pass_email_not_founded": "User with e-mail: %{email} not found!",
        "reset_pass_send": "Mail with instructions has been sended to e-mail:  %{email}!",
        "send_verif_instruct": "Mail to %{email} has been sended!",
        "uncorrect_login_data": "Uncorrect e-mail or password!",
        "uncorrect_params": "Uncorrect params!",
        "user_mails_thank": "Thank you for your message! We will contact you as soon as possible!",
        "user_not_agreed": "To use the service, you must accept the user agreement.",
        "user_not_deleted_self": "You has not been deleted self!",
        "user_not_verificated": "User %{user} has not been verificated!",
        "user_verificated": "User %{user} has been verificated!",
        "usr_deleted": "User \"%{ulogin}\" has been deleted!",
        "usr_not_deleted": "User \"%{ulogin}\" has not been deleted!",
        "usr_updating": "Updating your profile is success",
        "warning": "Warning!",
        "welcome_msg": "%{user}, welcome to Coordinate!"
    },
    ...
    "number": {
        ...
        "human": {
            ...
            "storage_units": {
                "format": "%n %u",
                "units": {
                    "byte": {"few": "байта", "many": "байт", "one": "Byte", "other": "Bytes"},
                    "eb": "EB",
                    "gb": "GB",
                    "kb": "KB",
                    "mb": "MB",
    ...
    "shared": {
        "empty_message": {
            ...
            "sub_msg": "You forgot something, and something we have lost..."
        },
        "question": {"body_default": "Some body text...", "header_default": "Some header text..."},
        "settings_nav": {
    ...
    "simple_form": {
        "error_notification": {"default_message": "Please review the problems below:"},
        "labels": {
            "car": {"color": "Цвет", "description": "Описание", "priority": "Приоритет", "title": "Название"},
            "defaults": {
                "email": "E-mail",
        ...
        "no": "No",
        "required": {"mark": "*", "text": "required"},
        "yes": "Yes"
    },
    "speed_val": "km/h",
    "static_pages": {
        "agreement": {"agreed_but": "Agree with the terms"},
        "home4guest": {
            "descript1": "Coordinate is a service of constant monitoring the location of your car",
            "welcome": "Welcome to Coordinate!"
        },
        "home4user": {
            "date_pick": "Date pick:",
            "date_pick_at": "at:",
    ...
    "users": {
        ...
        "edit": {
            ...
            "change_gravatar_hint": "Your Gravatar changes to the project site \"Gravatar\"",
            "delete_avatar_hint": "Will use an avatar from http://gravatar.com, and native avatar will be deleted.",
            "delete_avatar_label": "Don't use native avatar",
            "head1": "User settings",
        ...
        "reset_password_email_form": {
            "head1": "Reset your password, Step 1",
            "head2": "To your email address sent an email with instructions required to reset your password. Please check your e-mail!"
        },
        "reset_password_new_pass_request": {
            "head1": "Reset your password, Step 2",
            "head2": "Enter your new password!"
        },
        "show": {"edit_info": "Edit information"},
        "users_charts": {"track_statistic_head": "General statistic of your tracks"},
        "verification": {"head2": "To your email address sent an email with instructions required to confirm your e-mail. Please check your e-mail!"},
        "verification_form": {"letter_to": "key a letter to %{mail}", "verification_key": "Verification key:"}
    },
